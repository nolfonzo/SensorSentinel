...
#ifndef HELTEC_PINS_H
#define HELTEC_PINS_H

#include <Arduino.h>

// Common constants for all boards
#define HELTEC_ANALOG_COUNT    4  // All boards have 4 analog pins
#define HELTEC_BOOLEAN_COUNT   8  // All boards have 8 boolean pins
...
// Available pins for external use (analog and digital) - board specific
  ...
  #define HELTEC_BOOLEAN_PINS    {39, 40, 41, 42, 43, 44, 45, 46}
  ...
  #define HELTEC_ANALOG_PINS     {1, 2, 3, 4}
  #define HELTEC_BOOLEAN_PINS    {5, 6, 7, 33, 34, 35, 36, 37}
