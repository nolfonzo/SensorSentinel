 ...
 ******************************************************************************/
    ...
    */
     ...
     */
    // Alert state (last known state per pin) lives in flow context. Without
    // persistence a restart wipes it, every pin resets to a NORMAL baseline,
    // and any already-active alert re-fires as though it were new.
    contextStorage: {
        default: {
